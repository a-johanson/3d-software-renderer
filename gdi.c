...
//void ptc_mouse(int * mov_x, int * mov_y)
//{
//	RECT window_rect;
//	POINT mouse_pos;
//	
...
//	
//	*mov_x=mouse_pos.x-(window_rect.left+(surface_width/2));
//	*mov_y=mouse_pos.y-(window_rect.top+(surface_height/2));
//	
//	SetCursorPos(window_rect.left+(surface_width/2), window_rect.top+(surface_height/2));
//}
